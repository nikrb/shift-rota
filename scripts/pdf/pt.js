...
function loadComplete(){
  ...
  console.log( "import shifts:", shift_list);
  /*
  getUsers( user_names)
  .then( function( user_list){
    var shifts = shift_list.map( function( date_str){
      var ownerId = getUserIdByName( user_list, date_str.owner_name);
      var clientId = getUserIdByName( user_list, date_str.client_name);
      return {
        owner_id : ownerId,
        client_id : clientId,
        start_time : date_str.start_time.toDate(),
        end_time : date_str.end_time.toDate()
      };
    });
